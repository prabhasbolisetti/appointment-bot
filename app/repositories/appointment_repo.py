...
def get_appointment_with_details(appointment_id: str) -> dict:
    ...
    try:
        ...
        logger.error("Failed to fetch appointment details. Run latest migrations: %s", exc)
        return None
...
def get_appointments_with_details(clinic_id: str, status: str = None) -> list:
    ...
    try:
        ...
        logger.error("Failed to fetch appointments. Run latest migrations: %s", exc)
        return []
...
def get_confirmed_appointments_needing_reminder(clinic_id: str) -> list:
    ...
    try:
        ...
        logger.error("Failed to fetch reminders. Run latest migrations: %s", exc)
        return []
